...
require (
	...
	github.com/openshift/cluster-node-tuning-operator v0.0.0-20250220083025-34a44d1a9300
...
replace (
	...
	github.com/openshift/cluster-node-tuning-operator => github.com/openshift/cluster-node-tuning-operator v0.0.0-20250220083025-34a44d1a9300 // release-4.14
